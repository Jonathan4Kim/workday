      ...
      <div className="flex min-h-full flex-1">
          ...
          <div className="mx-auto w-full max-w-sm lg:w-96">
            <div>
              ...
              <h2 className="mt-8 text-2xl font-bold leading-9 tracking-tight text-gray-900">
                Sign in to your {recruiter ? 'Recruiter' : 'Applicant'} account
              </h2>
            ...
            <div className="mt-3">
              <div>
                ...
                <label htmlFor="email" className="block text-sm font-medium leading-6 text-gray-900 mb-2">
                      Toggle to switch to {recruiter ? 'Applicant' : 'Recruiter'}
                    </label>
                  <Switch
                    checked={recruiter}
                  ...
                  >
                    ...
                    <span
                      ...
                      className={classNames(
                        recruiter ? 'bg-indigo-600' : 'bg-gray-200',
                    ...
                    <span
                      aria-hidden="true"
                      className={classNames(
                        recruiter ? 'translate-x-5' : 'translate-x-0',
                ...
                <form action="#" method="POST" className="space-y-6">
                  ...
                  <div>
                    <button
                      ...
                      onClick={() => {
                        recruiter ? navigate('/recruiter/jobs') :
        ...
        <div className="relative hidden w-0 flex-1 lg:block">
          <img
            ...
            src="https://images.unsplash.com/photo-1487528278747-ba99ed528ebc?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt=""
          />
        </div>
      </div>
