...
const navigation = [
    { name: 'Jobs', href: '/recruiter/jobs', current: true },
    { name: 'Create', href: '/recruiter/explore', current: false },
    ...
    return (
        <div className="flex flex-row h-screen">
            ...
            <div className="flex flex-col w-full">
                <h1 className="bg-blue-700 text-white text-2xl font-semibold w-full h-20 self-center content-center px-8">Welcome Back, ACME Recruiter</h1>
                {children}
            </div>
