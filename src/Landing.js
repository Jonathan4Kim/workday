      ...
      <div className="bg-blue-950">
        <main>
          ...
          <div className="relative isolate overflow-hidden">
            ...
            >
              <div
                className="aspect-[1108/632] w-[69.25rem] bg-gradient-to-r from-[#3b4d60] to-[#ff7a0c] opacity-20"
                style={{
                  clipPath:
          ...
          <div className="mx-auto mt-8 max-w-7xl px-6 sm:mt-16 lg:px-8">
            ...
            <div className="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
              ...
              <img
                ...
                src="https://upload.wikimedia.org/wikipedia/commons/e/e2/McKinsey_and_Company_Logo_1.svg"
                alt="Mckinsey"
                width={158}
                height={48}
              />
                ...
                {primaryFeatures.map((feature) => (
                  <div key={feature.name} className="flex flex-col">
                    ...
                    <dd className="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-300">
                      ...
                      <p className="mt-6">
                        {/* <a href={feature.href} className="text-sm font-semibold leading-6 #ff7a0c">
                ...
                {secondaryFeatures.map((feature) => (
                  <div key={feature.name} className="relative pl-9">
                    <dt className="inline font-semibold text-white">
                      <feature.icon className="absolute left-1 top-1 h-5 w-5 #ff7a0c" aria-hidden="true" />
                      {feature.name}
                    </dt>{' '}
          ...
          <div className="mx-auto max-w-3xl lg:max-w-4xl">
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-orange-500">Our track record</h2>
            <p className="mt-2 text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white">
          ...
          <dl className="mx-auto mt-16 grid max-w-3xl grid-cols-1 gap-x-8 gap-y-10 text-white sm:mt-20 sm:grid-cols-2 sm:gap-y-16 lg:mx-0 lg:max-w-7xl lg:grid-cols-4">
            {stats.map((stat) => (
              <div key={stat.id} className="flex flex-col gap-y-3 border-l border-white/10 pl-6">
                <dt className="text-sm leading-6">{stat.name}</dt>
                <dd className="order-first text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tight">{stat.value}</dd>
              </div>
            ))}
          </dl>
          </div>
          ...
          <div className="relative isolate mt-32 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8">
            ...
            <div className="mx-auto max-w-2xl text-center">
              ...
              <a href="#"
                  className="rounded-md bg-orange-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
                  Get started
                </a>
